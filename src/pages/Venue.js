  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-primary transition-colors duration-200">
          ...
          <div className="text-center px-4 z-10">
            ...
            <div className="mt-8 animate-fade-in-delayed-2">
              <div className="inline-block bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-8 py-4">
                <p className="text-white text-lg font-medium">{t('heroDate')}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl p-8 transition-colors duration-200">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors duration-200">
                  {t('resortDetails', { suites: t('suites'), restaurants: t('restaurants'), bars: t('bars') })}
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('features.location.title')}</p>
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-200">{t('features.location.description')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('features.allInclusive.title')}</p>
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-200">{t('features.allInclusive.description')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('features.beach.title')}</p>
                      <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-200">{t('features.beach.description')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-6 z-10">
                  <h3 className="font-script text-3xl text-white mb-1">{t('ceremony.title')}</h3>
                  <p className="text-white text-lg opacity-90">{t('ceremony.time')}</p>
                </div>
              </div>
              <div className="p-8">
                <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors duration-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    ...
                    <span>{t('ceremony.details.time')}</span>
                  </div>
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    <svg className="w-5 h-5 text-primary dark:text-primary-light mr-3 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                    ...
                    <span>{t('ceremony.details.location')}</span>
                  </div>
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    <svg className="w-5 h-5 text-primary dark:text-primary-light mr-3 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                    <span>{t('ceremony.details.attire')}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-6 z-10">
                  <h3 className="font-script text-3xl text-white mb-1">{t('reception.title')}</h3>
                  <p className="text-white text-lg opacity-90">{t('reception.time')}</p>
                </div>
              </div>
              <div className="p-8">
                <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed transition-colors duration-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    ...
                    <span>{t('reception.details.time')}</span>
                  </div>
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    <svg className="w-5 h-5 text-secondary dark:text-secondary-light mr-3 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                    </svg>
                    <span>{t('reception.details.activities')}</span>
                  </div>
                  <div className="flex items-center text-gray-700 dark:text-gray-300 transition-colors duration-200">
                    <svg className="w-5 h-5 text-secondary dark:text-secondary-light mr-3 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                    </svg>
                    <span>{t('reception.details.setting')}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl p-8 transition-colors duration-200">
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-200">
                {t('stayDescription', { weddingDate: t('weddingDate') })}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('stayFeatures.timeline.title')}</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200">{t('stayFeatures.timeline.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('stayFeatures.qualityTime.title')}</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200">{t('stayFeatures.qualityTime.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-medium text-gray-800 dark:text-gray-100 transition-colors duration-200">{t('stayFeatures.celebration.title')}</h4>
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-200">{t('stayFeatures.celebration.description')}</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-800 dark:bg-gray-900 text-white transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-script text-5xl mb-6 transition-colors duration-200">{t('planStayTitle')}</h2>
            <p className="text-xl text-gray-300 dark:text-gray-400 max-w-3xl mx-auto transition-colors duration-200">
              {t('planStayDescription')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-700 dark:bg-gray-800 rounded-2xl p-8 transition-colors duration-200">
              <h3 className="font-display text-2xl text-white mb-6">{t('bookingTitle')}</h3>
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-semibold text-primary-light mb-2">{t('resortContact.title')}</h4>
                  <p className="text-gray-200 dark:text-gray-300 transition-colors duration-200">{t('resortContact.name')}</p>
                  <p className="text-gray-200 dark:text-gray-300 transition-colors duration-200">{t('resortContact.address1')}</p>
                  <p className="text-gray-200 dark:text-gray-300 transition-colors duration-200">{t('resortContact.address2')}</p>
                </div>
                
                <div>
                  <h4 className="text-lg font-semibold text-primary-light mb-2">{t('directBooking.title')}</h4>
                  <a 
                ...
                <div>
                  <h4 className="text-lg font-semibold text-primary-light mb-2">{t('ourStay.title')}</h4>
                  <p className="text-gray-200 dark:text-gray-300 transition-colors duration-200">{t('ourStay.dates')}</p>
                  <p className="text-gray-200 dark:text-gray-300 transition-colors duration-200">{t('ourStay.weddingDay')}</p>
                  <p className="text-gray-200 dark:text-gray-300 text-sm mt-2 italic transition-colors duration-200">
                    {t('ourStay.suggestion')}
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Travel Tips */}
            <div className="bg-gray-700 dark:bg-gray-800 rounded-2xl p-8 transition-colors duration-200">
              <h3 className="font-display text-2xl text-white mb-6">{t('travelTips.title')}</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('travelTips.airport.title')}</p>
                    <p className="text-gray-300 dark:text-gray-400 text-sm transition-colors duration-200">{t('travelTips.airport.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('travelTips.documentation.title')}</p>
                    <p className="text-gray-300 dark:text-gray-400 text-sm transition-colors duration-200">{t('travelTips.documentation.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('travelTips.weather.title')}</p>
                    <p className="text-gray-300 dark:text-gray-400 text-sm transition-colors duration-200">{t('travelTips.weather.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('travelTips.currency.title')}</p>
                    <p className="text-gray-300 dark:text-gray-400 text-sm transition-colors duration-200">{t('travelTips.currency.description')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 bg-gray-700 dark:bg-gray-800 rounded-2xl p-8 transition-colors duration-200">
            <h3 className="font-display text-2xl text-white mb-6 text-center">{t('locationTitle')}</h3>
